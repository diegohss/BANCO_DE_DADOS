...
begin
	...
	set @mes_ant = dateadd(month,-1,@dataini)
...
INSERT INTO [bi_kivah].[dbo].[l_cal_month]
           (
           [month_id]
           ,[month_desc]
           ,[last_month_id]
	...
	@mes_nome_abrev + ' ' + cast(@ano as char(4)) month_desc,
	convert(char(6),@mes_ant,112) last_month_id,
	cast(@ano as varchar) + cast(@trimestre as varchar) qtr_id,
	@ano as year_id,
	@mes_nome_abrev + ' ' + cast(@ano as char(4)) month_desc_sch,
	@mes_nome_abrev + ' ' + cast(@ano as char(4)) month_desc_tch
