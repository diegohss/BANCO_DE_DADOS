create procedure sp_busca_empresa_e
(
...
begin
	...
	set @sql= @sql + ' and emp.cidade=''' + @cidade + ''''
end
...
begin
	...
	set @sql=@sql + ' and emp.endereco like ''%' + @endereco + '%'''
end
...
begin
	...
	set @sql=@sql + ' and contato like ''%' + @contato + '%'''
end
...
begin
	...
	set @sql= @sql + ' and emp.estado=''' + @estado + ''''
end
...
begin
	...
	set @sql= @sql + ' and emp.telefone=''' + @telefone + ''''
end
...
begin
	...
	set @sql= @sql + ' and fil.funcionarios=''' + @funcionarios + ''''
end
...
begin
	...
	set @sql= @sql + ' and fil.faturamento=''' + @faturamento + ''''
end
...
begin
	...
	set @sql= @sql + ' and fil.origem=''' + @origem + ''''
end
...
begin
	...
	set @sql= @sql + ' and fil.cidade=''' + @cidade_filial + ''''
end
...
begin
	...
	set @sql=@sql + ' and fil.endereco like ''%' + @endereco_filial + '%'''
end
...
begin
	...
	set @sql=@sql + ' and fil.nome like ''%' + @filial + '%'''
end
...
begin
	...
	set @sql=@sql + ' and cont.nome like ''%' + @contato + '%'''
end
...
begin
	...
	set @sql= @sql + ' and cont.cargo in (''' + @cargo + ''',''' + @cargo2 + ''',''' + @cargo3 + ''')'
end
