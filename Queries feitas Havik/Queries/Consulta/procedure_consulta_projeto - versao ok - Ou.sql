create procedure sp_busca_projeto_ou
(
...
begin
	...
	set @sql= @sql + ' or grad.graduacao=''' + @graduacao + ''''
end
...
begin
	...
	set @sql= @sql + ' or proj.id_empresa=''' + @empresa + ''''
end
...
begin
	...
	set @sql= @sql + ' or proj.id_empresa=''' + @empresa2 + ''''
end
...
begin
	...
	set @sql= @sql + ' or req.salario_mensal betweem''' + @sal_ini + '''' + ' and ''' + @sal_fim + ''''
end
...
begin
	...
	set @sql= @sql + ' or req.salario_mensal>=''' + @sal_ini + ''''
end
...
begin
	...
	set @sql= @sql + ' or idi.id_idioma=' + @idioma2
end
