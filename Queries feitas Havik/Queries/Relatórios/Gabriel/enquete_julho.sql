...
select count (descricao), resp.descricao

		--base.id_resposta,resp.descricao,base.id_cliente,cproj.id_projeto,
...
where CONVERT(char(10),base.dt_alteracao,23) between '2012-06-01' and '2012-06-31' 
and base.id_pergunta=3
