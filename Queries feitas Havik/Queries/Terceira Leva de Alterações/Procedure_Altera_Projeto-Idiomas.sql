...
GO
create procedure [dbo].[sp_proj_altera_idiomas]
(
@id int,
@exibir int,
@usuario int,
...
set @id_projeto=(select id_projeto from bh_proj_idiomas where id=@id) 
...
where id=@id
		...
		begin
	   	...
	   	begin
			...
			values (@id_projeto,'alteracao_idiomas',GETDATE(),@usuario,'bh_proj_idiomas')	
	   		return(@retorno)	
		end
