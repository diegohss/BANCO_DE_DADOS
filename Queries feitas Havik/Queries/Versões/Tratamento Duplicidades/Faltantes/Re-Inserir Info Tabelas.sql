...
inner join tmp_cli_dup_faltantes2 dup on
	dup.id_cliente=arq.id_cliente 
left join bc_cli_base_cvs cvs on
	cvs.id_cliente=dup.id_nova	
where cvs.idioma<>arq.idioma and convert(char(10),arq.dt_criacao,23)>convert(char(10),cvs.dt_criacao,23)
