...
/****** Object:  Table dbo.bc_cli_consultor    Script Date: 10/04/2011 18:18:20 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE dbo.bc_cli_consultor_r(
...
ALTER TABLE dbo.bc_cli_consultor  WITH CHECK ADD FOREIGN KEY(movimento)
