...
IF ( OBJECT_ID('dbo.sp_cli_status_substatus') IS NOT NULL ) 
   DROP PROCEDURE dbo.sp_cli_status_substatus
GO
-- =============================================
-- Author:		Diego
...
-- =============================================
CREATE PROCEDURE sp_cli_status_substatus
(
@tipo int,
@id_status bigint,
@id_substatus bigint,
...
if @tipo=1
begin
	insert into bl_cli_status_substatus(id_status,id_substatus,usuario_criacao,dt_criacao)
...
if @tipo=1
begin
	update bl_cli_status_substatus
