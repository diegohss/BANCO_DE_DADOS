...
-- Description:	Fará o Insert na bh_emp_status
-- =============================================
create PROCEDURE [dbo].[sp_emp_status]
(
@tipo int,
@id_empresa bigint,
@id_status bigint,
...
begin
	...
	values (@id_empresa,'inserção',GETDATE(),@usuario,'bh_emp_status')
